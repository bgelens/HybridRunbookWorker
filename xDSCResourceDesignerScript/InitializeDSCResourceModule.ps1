New-xDscResource -ModuleName HybridRunbookWorker -Name MSFT_HybridRunbookWorker -FriendlyName HybridRunbookWorker -Path C:\GIT\ -ClassVersion 1.0.0.0 -Property @(
